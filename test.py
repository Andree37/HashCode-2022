...
class Project:
    ...
    def test1(self, contribs, skill_assigned, skill_left):
    ...
    def test2(self, contribs, skill_assigned, skill_left):
    ...
    def choose_contributors(self, contribs):
        ...
        self.test1(contribs, skill_assigned, skill_left)
        self.test2(contribs, skill_assigned, skill_left)
